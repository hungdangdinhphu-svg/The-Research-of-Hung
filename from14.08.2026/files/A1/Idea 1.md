...
**ĐẶC BIỆT :** "Tính Thứ Tự Toàn Phần" ("Total Order"): Không gian này phải mạnh ngang ngửa với tập số thực $\mathbb{R}$, tuy nhiên nó không được mắc phải các vấn đề gây cản trở của tập R, đảm bảo tính nhất quán của kết quả so sánh.
